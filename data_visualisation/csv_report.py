...
def generate_csv_report(y_true_inv, y_pred_inv, label_encoder, accuracy) -> None:
    ...
    # Save report.
    report_df.to_csv(
        "./drive/My Drive/Thesis/results/{}_dataset-{}_mammogramtype-{}_model-{}_lr-{}_b-{}_e1-{}_e2-{}_roi-{}_report.csv".format(
            config.run_mode,
            config.dataset,
...
def generate_csv_metadata(runtime) -> None:
    ...
    # Save report.
    metadata_df.to_csv(
        "./drive/My Drive/Thesis/results/{}_dataset-{}_mammogramtype-{}_model-{}_lr-{}_b-{}_e1-{}_e2-{}_roi-{}_metadata.csv".format(
            config.run_mode,
            config.dataset,
            config.mammogram_type,
            config.model,
