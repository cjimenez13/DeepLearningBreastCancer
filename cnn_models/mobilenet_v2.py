...
def create_mobilenet_model(num_classes: int):
    ...
    model_base = NASNetMobile(include_top=False, weights="imagenet", input_tensor=img_conc)
    ...
    fully_connected.add(Dropout(0.5, seed=config.RANDOM_SEED, name="Dropout_1"))
    fully_connected.add(Dense(units=256, activation='relu', name='Dense_1'))
    fully_connected.add(Dropout(0.5, name="Dropout_2"))
