...
def save_output_figure(title: str) -> None:
    ...
    """
    plt.savefig(
        "./drive/My Drive/Thesis/results/{}_dataset-{}_mammogramtype-{}_model-{}_lr-{}_b-{}_e1-{}_e2-{}_roi-{}_{}_{}.png".format(
            config.run_mode,
            config.dataset,
...
def load_trained_model() -> None:
    ...
    return load_model(config.name+'.h5')
    # return load_model(
    #     "./input/dataset-{}_mammogramtype-{}_model-{}_lr-{}_b-{}_e1-{}_e2-{}_roi-{}_{}_saved-model.h5".format(
    #         config.dataset,
    #         config.mammogram_type,
    #         config.model,
    #         config.learning_rate,
